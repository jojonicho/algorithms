...
void solve() {
  ...
  // count sum(count(p)) for each p in prime factors of x
  ...
  // largest factor should be <= sqrt(1e12) = 1e6
  // generate primes up to 1e6
  // this is wrong, counter = 2 * 1e9 + 7
  // there can be factors 
