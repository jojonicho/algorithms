...
*/
ll n_coprime(int d) { return r / d - (l - 1) / d; }
...
int main() {
  ...
  /*
  number of co-prime pairs of integers (x, y) in range [1, n].
  */
  for (int i = 2; i <= r; i++) {
    /*
    the number of pairs L ≤ x,y ≤ R
    such that
    gcd(x,y) is a multiple of k
    */
    ans += n_coprime(i) * n_coprime(i) * -sv.nums[i].mu;
    debug() << imie(i) imie(n_coprime(i)) imie(-sv.nums[i].mu);
  }
  debug() << imie(ans);
  /*
  ...
  */
  ...
  /*
    ...
    i = 2, mu[2] = 1
    (6, 4), (4, 6), (6, 6), (4, 4), (4, 8), (8, 8), (8, 6), (8, 4), (6, 8)
    3, mu = 1
    (3, 3) (3, 6) (6, 3) (6, 6)
    4, mu = 0
    (4, 4)
    5, mu = 1
    (5, 5)
    6, mu = -1 -> already computed twice
    (6, 6)
    7, mu = 1
    (7, 7)
    8, mu = 0
    (8, 8) -> already computed once

    ans = (4, 4) (4, 6) (4, 8) (6, 4) (6, 6) (6, 8) (8, 4) (8, 6) (3, 3) (3, 6)
    (6, 3) (5, 5) (7, 7) (8, 8)
    ...
    [i: 3]  [n_coprime(i): 2] (3, 6)  -> 2 * 2 - 1 = 3
    (4, 4) (4, 6) (4, 8) (6, 4) (6, 6) (6, 8) (8, 4) (8, 6) ~(3, 3) ~(3, 6) ~(6,
    3) (5, 5) (7, 7) (8, 8)

    [i: 4]  [n_coprime(i): 2] (4, 8)  -> 2 * 2 - 1 = 3
    ~(4, 4) (4, 6) ~(4, 8) (6, 4) (6, 6) (6, 8) ~(8, 4) (8, 6) ~(3, 3) ~(3, 6)
    ~(6, 3) (5, 5) (7, 7) (8, 8)
    ...
    final ans = (4, 6) (6, 4) (6, 8) (8, 6)

    */

  for (int i = max(2, l); i <= r; i++) {
    debug() << imie(i) imie(n_coprime(i));
    ans -= 2 * n_coprime(i) - 1;  // reduce with 2n - 1 pattern somehow
  }
